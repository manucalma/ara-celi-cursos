  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const cursoEncontrado = data.cursos.find((c: Curso) => c.id === params.cursoId)
        if (!cursoEncontrado) {
        ...
        const contenidoEncontrado = findContenidoByParam(cursoEncontrado.contenido, params.videoParam)
    ...
    fetchData()
  }, [params.cursoId, params.videoParam, router])

  const handleEdit = () => {
    if (contenido) {
      router.push(`/admin/cursos/${params.cursoId}/contenido/${contenido.id}/editar`)
    }
  }
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="flex items-center gap-2">
            ...
            <AdminMenu cursoId={params.cursoId} videoParam={params.videoParam} />
          </div>
        </div>
